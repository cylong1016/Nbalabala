...
public class PlayerDataPanel extends BottomPanel {
	...
	private int three = 380, block = 509, steal = block + inter, foul = block + 2 * inter,
			turnover = block + 3 * inter, minute = block + 4 * inter;
	/** 罚球 两双 */
	...
	/** 所有button横坐标集合 */
	private int[] buttonX = new int[]{allX, x1, x2, x3, allX, x1, x2, x3, east, west, pacific, northWest, southWest,
										allX, x1, x2, x3, three, block, steal, foul, turnover, minute, x1, x2, x3,
										freeThrow, double_double, total, average};
	/** 所有button上文字部分横坐标集合 */
	private String[] text = new String[]{"所有", "前锋", "中锋", "后卫", "所有", "东南", "中央", "大西洋", "东部", "西部", "太平洋", "西北",
											"西南", "所有", "得分", "篮板", "助攻", "得分/篮板/助攻", "盖帽", "抢断", "犯规", "失误", "分钟",
											"效率", "投篮", "三分", "罚球", "两双", "总计", "平均"};
	/** “所有”按钮组成一个数组 */
