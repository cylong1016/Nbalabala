...
public class PlayerAllSorter {
	...
	public void sort(ArrayList<PlayerSeasonPO> players, PlayerAllSortBasis basis, SortOrder order) {
		Comparator<PlayerSeasonPO> comparator = null;
		...
		switch(basis) {
		case MATCH_COUNT:
			comparator = new Comparator<PlayerSeasonPO>() {
		...
		case FIELD_MADE:
			comparator = new Comparator<PlayerSeasonPO>() {
				...
				public int compare(PlayerSeasonPO p1, PlayerSeasonPO p2) {
					return factor * (p1.getFieldMade() - p2.getFieldMade());
				}
			};
			break;
		...
		case THREE_POINT_MADE:
			comparator = new Comparator<PlayerSeasonPO>() {
				...
				public int compare(PlayerSeasonPO p1, PlayerSeasonPO p2) {
					return factor * (p1.getThreePointMade() - p2.getThreePointMade());
				}
			};
			break;
		...
		case FREETHROW_MADE:
			comparator = new Comparator<PlayerSeasonPO>() {
				...
				public int compare(PlayerSeasonPO p1, PlayerSeasonPO p2) {
					return factor * (p1.getFreethrowMade() - p2.getFreethrowMade());
				}
			};
			break;
		...
		case DOUBLE_DOUBLE:
			comparator = new Comparator<PlayerSeasonPO>() {
				...
				public int compare(PlayerSeasonPO p1, PlayerSeasonPO p2) {
					return factor * (p1.getDoubleDoubleCount() - p2.getDoubleDoubleCount());
				}
			};
			break;
		...
		case TEAM_NAME:
			comparator = new Comparator<PlayerSeasonPO>() {
				...
				public int compare(PlayerSeasonPO p1, PlayerSeasonPO p2) {
					return factor * (p1.getTeamAbbr().compareTo(p2.getTeamAbbr()));
				}
			};
			break;
		default:
