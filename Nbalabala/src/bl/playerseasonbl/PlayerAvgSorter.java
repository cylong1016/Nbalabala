...
public class PlayerAvgSorter {
	...
	public void sort(ArrayList<PlayerSeasonPO> players, PlayerAvgSortBasis basis, SortOrder order) {
		...
		case FIELD_MADE_AVG:
			comparator = new Comparator<PlayerSeasonPO>() {
				...
				public int compare(PlayerSeasonPO p1, PlayerSeasonPO p2) {
					return (int)(factor * (p1.getFieldMadeAvg() - p2.getFieldMadeAvg()) * 10000);
				}
			};
			break;
		...
		case FREETHROW_MADE_AVG:
			comparator = new Comparator<PlayerSeasonPO>() {
				...
				public int compare(PlayerSeasonPO p1, PlayerSeasonPO p2) {
					return (int)(factor * (p1.getFreethrowMadeAvg() - p2.getFreethrowMadeAvg()) * 10000);
				}
			};
			break;
		...
		case THREE_POINT_MADE_AVG:
			...
			comparator = new Comparator<PlayerSeasonPO>() {
				public int compare(PlayerSeasonPO p1, PlayerSeasonPO p2) {
					return (int)(factor * (p1.getThreePointMadeAvg() - p2.getThreePointMadeAvg()) * 10000);
				}
			};
			break;
